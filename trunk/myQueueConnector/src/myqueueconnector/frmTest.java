...
public class frmTest extends javax.swing.JFrame
{
    ...
    public frmTest()
    {
        ...
        try
        {
            fConnector = new Connector(InetAddress.getByName("127.0.0.1"), 5001);
            fConnector.Start();
        }
        catch (Exception ex)
        {
    ...
    {//GEN-HEADEREND:event_jButton1ActionPerformed
        try
        {
            fConnector.Enqueue(String.valueOf(System.nanoTime()));
        }
    ...
    {//GEN-HEADEREND:event_jButton2ActionPerformed
        System.out.println(new String(fConnector.Peek().getBytes()));
